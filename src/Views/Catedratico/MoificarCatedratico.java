	...
	public MoificarCatedratico() {
		...
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FormularioModificar form = new FormularioModificar();
				form.formularioModificars(cui);
			}
		});
